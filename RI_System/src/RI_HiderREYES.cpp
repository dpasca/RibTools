				...
				Buffer2D<1>			&zBuff ) const
{
	...
	const SlColor	*pOi = (const SlColor *)g.mSymbols.LookupVariableData( "Oi", Symbol::COLOR );
	const SlColor	*pCi = (const SlColor *)g.mSymbols.LookupVariableData( "Ci", Symbol::COLOR );
