...
This document should come along the the code distribution of *RibTools*.

* See the `Developer Manual`_ for instructions on how to build and run *RibTools*.
* See the `User Manual`_ for instructions on how to execute *RibTools* binaries.

.. _Developer Manual: docs/Dev_Manual.pdf
